<?php
// include security headers (header.php must not have any output before <?php)
...
<head>
  ...
  <!-- Custom CSS (relative to project root: htdocs/loksamarpan) -->
  <link rel="stylesheet" href="CSS/style.css" />
</head>
<body>

  <!-- NAVBAR (output comes from header.php included above) -->
  ...
  <section class="section bg-light py-5" id="mission-vision">
    <div class="container text-center">
      ...
      <div class="btn-group mb-4" role="group" aria-label="mission vision buttons">
      ...
      <div id="missionContent" class="content-section d-block">
        <p class="lead text-muted">
          Our mission at <strong>LokSamarpan Trust</strong> is simple yet powerful — we aim to contribute to the development of society through compassion, innovation, and action.
        </p>
      </div>

      <div id="visionContent" class="content-section d-none">
        <p class="lead text-muted">
          Our vision is a future where development reaches every corner of society; education, healthcare, and sustainable energy are accessible to all.
        </p>
      </div>
    </div>
  </section>
  ...
  <script>
    function showContent(type) {
      ...
      if (type === 'mission') {
        missionContent.classList.remove('d-none'); missionContent.classList.add('d-block');
        visionContent.classList.remove('d-block'); visionContent.classList.add('d-none');

        missionBtn.classList.add('active', 'btn-success'); missionBtn.classList.remove('btn-outline-success');
        visionBtn.classList.add('btn-outline-success'); visionBtn.classList.remove('active', 'btn-success');
      } else {
        visionContent.classList.remove('d-none'); visionContent.classList.add('d-block');
        missionContent.classList.remove('d-block'); missionContent.classList.add('d-none');

        visionBtn.classList.add('active', 'btn-success'); visionBtn.classList.remove('btn-outline-success');
        missionBtn.classList.add('btn-outline-success'); missionBtn.classList.remove('active', 'btn-success');
      }
    }
  </script>

  <!-- PROJECTS SECTION -->
  <?php include __DIR__ . '/components/project.php'; ?>
