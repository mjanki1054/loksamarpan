  ...
  <div class="container text-center text-md-start">
    <div class="row">
      <div class="col-md-4 mb-4">
        ...
        <p class="small">
          LokSamarpan Trust is a non-profit organization dedicated to holistic social development, 
      ...
      <div class="col-md-4 mb-4">
        <h6 class="text-uppercase fw-bold text-success">Contact</h6>
        <p class="small mb-1"><i class="fas fa-map-marker-alt me-2 text-success"></i> Gumla, Jharkhand, India</p>
        <p class="small mb-1"><i class="fas fa-envelope me-2 text-success"></i> loksamarpan.ngo@gmail.com</p>
        <p class="small"><i class="fas fa-phone me-2 text-success"></i> +91 1234567890</p>
      </div>
    </div>
